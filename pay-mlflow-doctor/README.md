...
분석 보고서의 파일 및 프로젝트 경로는 개발자 PC나 CI 환경에 종속되지 않도록 워크스페이스 기준 상대경로로 표시합니다.
...
- macOS local path(`/Users/...`, `/Volumes/...`, `/private/...`) 탐지
...
13. macOS/Linux/Windows local path: `/Users/...`, `/Volumes/...`, `C:\...`, `file:`, `./...`
14. uri: `models:/`, `runs:/`, `file:`, `s3://`, `gs://`, Windows path
